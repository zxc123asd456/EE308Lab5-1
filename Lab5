...
public class lab1 {
	...
	public static double grade3_4(double Q_num)
	{
		...
		double score  = 0;
		for(int i = 0;i<Q_num;i++) {
			num1 = rand.nextInt(MAX)-MAX+rand.nextInt(MAX);
			num2 = rand.nextInt(MAX)-MAX+rand.nextInt(MAX);
			sign = rand.nextInt(4);
			if(sign == 1) 
			{
				System.out.print(num1+"+"+num2+"=?"+" input reply = ");
	...
	public static double grade5_6(double Q_num)
	{
		...
		double score  = 0;
		for(int i = 0;i<Q_num;i++) {
			num1 = (rand.nextInt(MAX)-MAX+rand.nextInt(MAX))+rand.nextInt(100)/100.0;
			num2 = (rand.nextInt(MAX)-MAX+rand.nextInt(MAX))+rand.nextInt(100)/100.0;
			sign = rand.nextInt(4);
			if(sign == 1) 
			{
				System.out.print(num1+"+"+num2+"=?"+" input reply = ");
